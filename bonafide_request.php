...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (move_uploaded_file($_FILES['proof']['tmp_name'], $target_file)) {
        $query = "INSERT INTO bonafide_requests (student_id, reason, document) VALUES ('$student_id', '$reason', '$proof')";
...
<body>
    <div class="container">
        <h1>Bonafide Request</h1>
        <form action="bonafide_request.php" method="post" enctype="multipart/form-data">
